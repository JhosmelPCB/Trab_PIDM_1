        ...
        qrDetailList.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                if (touchListener.existPendingDismisses())
                {
                    ...
                    Toast.makeText(MainActivity.this, "Se encuentra en la posicion " + position, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(result != null)
        {
            if(result.getContents() == null)
            {
                ...
                statement.execute();
                Toast.makeText(getApplicationContext(),"Se guardo la captura del Codigo Escaneado en el Servidor Local",Toast.LENGTH_LONG).show();

                //Alerta Aceptacion Firebase
